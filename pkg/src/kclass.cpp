...
CKClass::CKClass(int cNumClasses, int cRows)
{
...
GBMRESULT CKClass::UpdateParams
(
    double *adF,
	double *adOffset,
	double *adWeight,
...
GBMRESULT CKClass::ComputeWorkingResponse
(
    double *adY,
    double *adMisc,
    double *adOffset,
...
GBMRESULT CKClass::FitBestConstant
(
    double *adY,
    double *adMisc,
    double *adOffset,
